...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MedicalRecords.MedicalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RecommendationForPatient")
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)");
            ...
            modelBuilder.Entity("Domain.MedicalRecords.MedicalRecord", b =>
                {
                    b.HasOne("Domain.Appointments.Appointment", "Appointment")
                        .WithOne()
                        .HasForeignKey("Domain.MedicalRecords.MedicalRecord", "AppointmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
